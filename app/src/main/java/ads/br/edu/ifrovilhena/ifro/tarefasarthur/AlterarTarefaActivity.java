package ads.br.edu.ifrovilhena.ifro.tarefasarthur;
...
import ads.br.edu.ifrovilhena.ifro.tarefasarthur.dao.AppDatabase;
...
public class AlterarTarefaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tilAlterarDescricao = (TextInputEditText) findViewById(R.id.til_alterar_descricao);
        ...
        btnAlterar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tarefa.setDescricao(tilAlterarDescricao.getText().toString().trim());
